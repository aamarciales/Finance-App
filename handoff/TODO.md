...
_(Todos los bugs de sesión 6 cerrados.)_
...
- [x] Bug E — cerrado sesión 6 (Badge usa color real + PUT endpoint + color picker nativo)
- [x] Bug C2 — ya implementado (warn en dev para IDs huérfanos)
