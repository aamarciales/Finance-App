    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-2xl p-0 overflow-hidden">
        <div className="max-h-[85vh] overflow-y-auto">
          {loading || !invoice ? (
            <div className="p-10 text-center text-text-muted">Loading invoice…</div>
          ) : (
            <>
              <div className="border-b border-border bg-surface px-6 py-4">
                ...
                <p className="text-[12px] text-text-muted">{invoice.date} · {invoice.itemCount} items</p>
              </div>
                  ...
                  <table className="w-full text-left text-[13px]">
                    <thead>
                      <tr className="border-b border-border text-[11px] uppercase tracking-[0.06em] text-text-faint">
                        ...
                        <th className="w-16 py-1.5 px-2 text-center font-medium hidden sm:table-cell">Qty</th>
